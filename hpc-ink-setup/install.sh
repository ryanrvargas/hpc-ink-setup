...
# Use the true Copilot CLI entrypoint to avoid recursion
...
# Join all args into one prompt string
prompt_text="$*"

# Block dangerous commands inside prompts
...
# Try -p syntax first; if Copilot complains, fallback to 'suggest'
...
# --- Verification (protected from set -e) ---
set +e
echo
echo "=== Verification ==="
